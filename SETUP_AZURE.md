...
```
SUPABASE_URL=https://edtmvbxxgujjtowveknz.supabase.co
...
1. Go to your [Supabase dashboard](https://supabase.com/dashboard/project/edtmvbxxgujjtowveknz)
...
1. Go to [Supabase dashboard](https://supabase.com/dashboard/project/edtmvbxxgujjtowveknz)
